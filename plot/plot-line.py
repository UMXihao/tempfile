...
def plot_line():
    ...
    orac = np.array([0.397420061,0.865726496,0.406816742,0.999243106,0.997906625,0.953155645,0.996871812,0.999824779,0.999818606,0.999633908,0.999789468,0.99976784,0.99969812,0.99959359,0.99951859,0.999342706,0.999091446,0.998577535,0.998165292,0.99755707,0.997551918,0.99745552,0.996633717,0.990406079,0.895516362,0.615302469])
    llama = np.array([0.437694703,0.089435097,0.9999832,0.999973774,0.999826585,0.99988842,0.999867056,0.999829267,0.999779037,0.999732801,0.999693164,0.999690558,0.999641716,0.999512179,0.999400113,0.999114437,0.998718449,0.998747238,0.998492735,0.998158514,0.99815395,0.997945939,0.997805987,0.998023144,0.997723111,0.998082578,0.997678586,0.99725037,0.996569301,0.996060159,0.780090886,0.4494008])
    mpt = np.array([0.435176611,0.830939174,0.999904573,0.999910057,0.999863982,0.999817312,0.999795794,0.999759436,0.999716401,0.999710917,0.999678969,0.999684393,0.999640584,0.999633551,0.999504805,0.999637485,0.999663055,0.999641716,0.999632001,0.999599338,0.999600708,0.999608815,0.999585688,0.999554217,0.999531567,0.999475539,0.999423802,0.999361813,0.997995019,0.614898205,0.150938004])
    intern_lm = np.array([-0.058101114,0.99997431,0.999952435,0.999942303,0.99990046,0.999834836,0.999907672,0.99979353,0.999887228,0.99986577,0.99984175,0.999896884,0.999786317,0.999709308,0.999571145,0.998973727,0.998458803,0.998307884,0.997122347,0.997290432,0.99809587,0.99832499,0.998099983,0.998736739,0.998680472,0.998520076,0.997200489,0.996272802,0.991735101,0.981259882,0.120631248])
    vicuna = np.array([0.324582487,0.839181483,0.481164783,0.999973893,0.999889612,0.999929607,0.999919713,0.999865055,0.999837697,0.999857664,0.999855816,0.999775231,0.999744952,0.999727249,0.999643028,0.999525547,0.999283254,0.99906671,0.998992562,0.998760164,0.99843961,0.99836129,0.998308241,0.998219252,0.998225689,0.997999728,0.997719288,0.997715116,0.997310042,0.996389747,-0.063855357,0.586223841])
    ...
    plt.plot(x, orac, marker='s', markersize=markersize, color="blue", label="MHA", linewidth=linewidth)
    plt.plot(x, llama, marker='X', markersize=markersize, color="tomato", label="MLP", linewidth=linewidth)
    plt.plot(x, mpt, marker='X', markersize=markersize, color="tomato", label="MLP", linewidth=linewidth)
    plt.plot(x, intern_lm, marker='X', markersize=markersize, color="tomato", label="MLP", linewidth=linewidth)
    plt.plot(x, vicuna, marker='X', markersize=markersize, color="tomato", label="MLP", linewidth=linewidth)
